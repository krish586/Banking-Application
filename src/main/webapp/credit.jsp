...
<title>Debit</title>
<link rel="stylesheet" href="./credit.css" type="text/css">
</head>
<body>
	<div class="container">
	<h1>Debit of Internet Banking</h1>
	<form class="form" action="crediturl" method="post">
	...
	<%
	String receipt = (String)session.getAttribute("recp");
